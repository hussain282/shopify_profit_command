...
# REMOVED: File upload sections from sidebar

# Initialize data validator
validator = DataValidator()

# --- 📈 DATA PROCESSING PIPELINE ---
# Always use sample data since upload is removed
st.sidebar.markdown('<div class="data-warning">🎯 Using premium sample data</div>', unsafe_allow_html=True)
...
st.markdown('<div class="data-success">✅ Premium sample data loaded - analyzing complete dataset</div>', unsafe_allow_html=True)
